...
{
	protected Vector<Widget> filledHandlers;
	protected Vector<Widget> parameters;
	protected boolean doGet = true;
	/** The event handlers registered with this user data object. */
	private final LinkedList<Widget> eventHandlers = new LinkedList<Widget>();
	...
	public void init()
	{
		filledHandlers = new Vector<Widget>();
		parameters = new Vector<Widget>();
	}

	public void setDoGet(boolean b)
	{
		doGet = b;
	}
	...
	protected void writeAttributes(AttributesImpl attributes)
	{
		...
		writeAttribute(attributes, null, null, "classid", TYPE_CDATA, "CRData:" + (doGet ? "get" : "put"));
	}
