...
public class ResourceChooserDialog extends Dialog {
		...
		viewer.addSelectionChangedListener(new ISelectionChangedListener() {
			public void selectionChanged(SelectionChangedEvent event) {
				...
				if ((selection == null) || selection.isEmpty()) {
					...
					ResourceChooserDialog.this.getButton(OK)
							.setEnabled(!selection.getFirstElement().toString().endsWith("/"));
				}
			}
		});
	 ...
	 * @author Lonnie Pryor
	 */
	private final class FilesContentProvider implements IStructuredContentProvider, ITreeContentProvider {
		/*
		 * (non-Javadoc)
		 * 
		 * @see
