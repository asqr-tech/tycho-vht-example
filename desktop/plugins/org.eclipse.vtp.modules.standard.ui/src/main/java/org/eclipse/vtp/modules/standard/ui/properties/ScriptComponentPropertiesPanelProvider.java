 ...
 *
 */
public class ScriptComponentPropertiesPanelProvider implements
	ComponentPropertiesPanelProvider
{
	 ...
	 * 
	 */
	public ScriptComponentPropertiesPanelProvider()
	{
	}
		...
		IDesignComponent designComponent)
	{
		...
		ret.add(new ScriptPropertiesPanel("General", pe));
		return ret;
	}
	...
	public boolean isApplicableFor(IDesignComponent designComponent)
	{
		if(!(designComponent instanceof PrimitiveElement))
			return false;
		PrimitiveElement pe = (PrimitiveElement)designComponent;
		return pe.getSubTypeId().equals("org.eclipse.vtp.modules.standard.ui.script");
	}
