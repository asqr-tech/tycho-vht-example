 ...
 *
 */
public class ComparisonComponentPropertiesPanelProvider implements
	ComponentPropertiesPanelProvider
{
	 ...
	 * 
	 */
	public ComparisonComponentPropertiesPanelProvider()
	{
	}
		...
		IDesignComponent designComponent)
	{
		...
		ret.add(new ComparisonPropertiesPanel("Comparison", pe));
		return ret;
	}
	...
	public boolean isApplicableFor(IDesignComponent designComponent)
	{
		if(!(designComponent instanceof PrimitiveElement))
			return false;
		PrimitiveElement pe = (PrimitiveElement)designComponent;
		return pe.getSubTypeId().equals("org.eclipse.vtp.modules.standard.ui.decision");
	}
