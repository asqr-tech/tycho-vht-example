...
public class AttachedDataMessageBindingLegacyConverter implements XMLConverter
{

	public AttachedDataMessageBindingLegacyConverter()
	{
	}
	...
	public void convert(Element element) throws ConversionException
	{
		...
		replacement.setAttribute("type", "org.eclipse.vtp.configuration.attacheddata");
