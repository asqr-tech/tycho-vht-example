	...
	IExecutableExtension
{
	...
	{
		WorkflowProject workflowProject = (WorkflowProject)WorkflowCore.getDefault().getWorkflowModel().createWorkflowProject(WorkflowProjectNature.NATURE_ID, applicationPage.nameField.getText());
		buildPathPage.configureBuildPath(workflowProject);
	...
	public boolean canFinish(){
		return buildPathPage.equals(getContainer().getCurrentPage());
	}
	...
	public class BuildPathPage extends WizardPage
	{
		...
		public void createControl(Composite parent)
		{
			setControl(screen.createContents(parent));
		}
