...
public class CopyAction extends SelectionListenerAction {
	...
	public void run() {
		...
		for (Object selectedResource : selectedResources)
			resources[temp++] = (IResource) selectedResource;
	...
	protected boolean updateSelection(IStructuredSelection selection) {
		...
		for (Object currentResource : selectedResources) {
			if (!((IResource) currentResource).getParent().equals(firstParent)) {
				return false;
			}
			// resource location must exist
			if (((IResource) currentResource).getLocationURI() == null) {
				return false;
			}
		}
