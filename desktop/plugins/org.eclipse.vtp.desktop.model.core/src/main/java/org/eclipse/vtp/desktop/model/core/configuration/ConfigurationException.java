...
public class ConfigurationException extends Exception {
	...
	private static final String[] STANDARD_MESSAGES = new String[] { "Unknow exception occured in configuration",
			"The configuration version is not supported", "The configuration appears to be from a newer version",
