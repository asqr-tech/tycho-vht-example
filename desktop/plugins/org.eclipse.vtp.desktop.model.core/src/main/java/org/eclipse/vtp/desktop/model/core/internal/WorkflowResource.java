 ...
 * @version 2.0
 */
public abstract class WorkflowResource implements IWorkflowResource, ObjectListener, IContributorResourceAdapter {
	/**
	...
	protected void finalize() throws Throwable {
		WorkflowCore.getDefault().unregisterObjectListener(getObjectId(), this);
		super.finalize();
	}

	/**
	 * The object id is used by the event system to uniquely identify a project
	 * resource. In this fashion, multiple references to the resource can be created
	 * and still be notified of events.
	 *
	 ...
	 * 
	 * @see
	 * org.eclipse.vtp.desktop.core.project.IVoiceResource#addRefreshListener(org.
	 * eclipse.vtp.desktop.core.project.event.IRefreshListener)
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.vtp.desktop.core.project.IVoiceResource#removeRefreshListener(org
	 * .eclipse.vtp.desktop.core.project.event.IRefreshListener)
	 */
	 ...
	 * processObjectEvent(org.eclipse.vtp.desktop.core.project.internals.event.
	 * ObjectEvent)
	 */
