...
public abstract class VoiceFormatter implements IFormatter {
	...
	/**
	 * Convenience function to locate a requested audio resource given the expected
	 * path and filename. This function attempts the locate the file using a set of
	 * file extensions. If the file is not located, the provided alternate text is
	 * wrapped in a TextContent object and returned.<br>
	 * <br>
	 ...
	 * @param path            The path to the file. This path is rooted at the voice
	 *                        project utilizing this language formatter.
	 * @param filename        The name of the file minus the extension.
	 * @param defaultText     The default text to be used if the file is not
	 *                        located.
	 ...
	 */
	protected Content getAudioContent(IResourceManager resourceManager, String path, String filename,
			String defaultText) {
		Content ret = null;
	 ...
	 * getDefaultFormatDefintion(org.eclipse.vtp.framework.interactions.core.media.
