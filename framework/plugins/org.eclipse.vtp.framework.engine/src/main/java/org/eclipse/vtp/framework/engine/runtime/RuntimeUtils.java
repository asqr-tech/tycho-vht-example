...
public final class RuntimeUtils {
	...
	/**
	 * Generates a unique string from the supplied element's name space URI and tag
	 * name.
	 * 
	 ...
	 */
	public static void listTypeHierarchy(Class<?> type, Set<Class> types) throws NullPointerException {
		if (type == null)
			return;
		if (types == null)
	 ...
	 *                                  has more or less elements than the specified
	 *                                  constructor does arguments.
	 * @throws IllegalStateException    If the object creation fails.
	 * @throws NullPointerException     If the supplied constructor is
	 *                                  <code>null</code>.
	 * @throws NullPointerException     If the supplied constructor argument array
	 ...
	 * @throws IllegalStateException    If the object creation fails.
	 * @throws NullPointerException     If the supplied instance is
	 *                                  <code>null</code>.
	 * @throws NullPointerException     If the supplied mutator is
	 *                                  <code>null</code>.
	 */
