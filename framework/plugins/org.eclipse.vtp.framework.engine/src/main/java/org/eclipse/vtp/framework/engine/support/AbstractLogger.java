...
public abstract class AbstractLogger extends AbstractReporter implements ILogger {
	/**
	 ...
	 * @param categories The categories the log entry pertains to or
	 *                   <code>null</code> if no catagories are related.
	 * @param message    The message associated with the log entry or
	 *                   <code>null</code> to not include a message.
	 * @param properties The properties of the log entry or <code>null</code> if no
	 *                   properties are specified.
	 */
	@SuppressWarnings("unchecked")
	protected void doLog(int severity, String[] categories, String message, Dictionary properties) {
		if (properties == null)
	 ...
	 */
	public final void log(int severity, String[] categories, String message, Dictionary properties) {
		if (isSeverityEnabled(severity))
	 ...
	 * java.lang.String, java.util.Dictionary)
	 */
	public final void error(String[] categories, String message, Dictionary properties) {
		if (isSeverityEnabled(SEVERITY_ERROR))
	 ...
	 * java.lang.String, java.util.Dictionary)
	 */
	public final void warn(String[] categories, String message, Dictionary properties) {
		if (isSeverityEnabled(SEVERITY_WARN))
	 ...
	 * java.lang.String, java.util.Dictionary)
	 */
	public final void info(String[] categories, String message, Dictionary properties) {
		if (isSeverityEnabled(SEVERITY_INFO))
	 ...
	 * java.lang.String, java.util.Dictionary)
	 */
	public final void debug(String[] categories, String message, Dictionary properties) {
		if (isSeverityEnabled(SEVERITY_DEBUG))
