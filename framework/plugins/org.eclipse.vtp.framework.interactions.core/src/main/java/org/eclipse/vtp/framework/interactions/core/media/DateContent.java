...
public class DateContent extends FormattableContent {
	...
	public List format(IFormatter formatter, IMediaProvider mediaProvider) {
		List<TextContent> ret = new LinkedList<TextContent>();
		if (getValueType() != VARIABLE_VALUE) {
			Calendar date = DateHelper.parseDate(getValue());
			if (date != null)
				ret.addAll(formatter.formatDate(date, mediaProvider.getFormatManager().getFormat(this, getFormatName()),
	...
	public static void main(String[] args) {
		String[] dates = new String[] { "3/4/1977 3:45:34 pm EST", "3/4/1977 3:45:34 pm", "3/4/1977 3:45:34 EST",
				"3/4/1977 3:45 pm EST", "3/4/1977 3:45 pm", "3/4/1977 3:45 EST", "3:45:34 pm EST", "3:45:34 pm",
				"3:45:34 EST", "3/31/2010 3:45:34 pm EST", "1-4-1977", "6/4/1977" };
