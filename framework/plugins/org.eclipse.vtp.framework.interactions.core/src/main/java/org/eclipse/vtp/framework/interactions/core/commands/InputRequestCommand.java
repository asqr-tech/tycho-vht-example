...
public final class InputRequestCommand extends ConversationCommand {
	...
	public Object exportContents() {
		...
		if (input != null) {
			...
			input2Ref[1] = null;
		return new Object[] { dataName, resultName, filledResultValue, noInputResultValue, noMatchResultValue,
				properties.toArray(new String[properties.size()]), output.toArray(new Object[output.size()]), inputRef,
				input2Ref, parameters.toArray(new String[parameters.size()]) };
	}
